/*   STEP 1   */
export const leagueID = "1257058203619831808"; // your league ID
export const leagueName = "National Degenerates League"; // your league name
...
export const homepageText = `
  ...
  /*   STEP 3 (optional) — Google Form embed   */
// Original fixed-size iframe:
export const homepageFormEmbed = `
